      ...
      <div className="max-w-[1920px] mx-auto">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-white/50">Target Environment:</span>
          </div>

          <div className="relative">
            <button
              onClick={() => setIsOpen(!isOpen)}
              className="flex items-center gap-3 px-5 py-2.5 rounded-xl hover:bg-white/5 transition-all duration-200"
              style={{
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-white/40">{selected.description}</div>
                </div>
              </div>
              <ChevronDown
                    ...
                    {environments.map((env) => (
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 hover:bg-white/5 transition-colors ${
                          env.value === selectedEnv ? 'bg-white/5' : ''
                        }`}
                      >
                        <div
                        ...
                        <div className="text-left flex-1">
                          ...
                          <div className="text-xs text-white/40">{env.description}</div>
                        </div>
