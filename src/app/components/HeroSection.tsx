...
export function HeroSection({ onCreateScenario, onKillAll }: HeroSectionProps) {
  const metrics = [
    { label: 'Active Rules', value: '6', icon: Activity, color: '#6B9AFF' },
    { label: 'Latency Injected', value: '12.4s', icon: Clock, color: '#FFB84D' },
    { label: 'Error Rate', value: '18%', icon: AlertTriangle, color: '#FF6B6B' },
    { label: 'Packet Drop', value: '20%', icon: Wifi, color: '#FFC857' },
  ];
